...
internal class GenericPropertyManagement(
    private val propertyValue: String,
    private val beagleClass: BeagleClass
) {

    fun getPropertySpec(customPropertyName: String?) = implementProperty (
        propertyValue,
        customPropertyName ?: Introspector.decapitalize(beagleClass.className),
        beagleClass
    )
