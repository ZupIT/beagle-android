...
const val FORM_LOCAL_ACTION_HANDLER_IMPORT = "import br.com.zup.beagle.android.action.FormLocalActionHandler"

const val VALID_FORM_LOCAL_ACTION_HANDLER =
    """
...
const val VALID_SECOND_FORM_LOCAL_ACTION_HANDLER =
    """
        @BeagleComponent
...
const val VALID_FORM_LOCAL_ACTION_HANDLER_BEAGLE_SDK_FROM_REGISTRAR =
    """
        @file:Suppress("OverridingDeprecatedMember", "DEPRECATION", "UNCHECKED_CAST")
        ...
        public final class BeagleSetup : BeagleSdk {
          public override val formLocalActionHandler: FormLocalActionHandler =
              br.com.test.beagle.FormLocalActionHandlerTestThree()
