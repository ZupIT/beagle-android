...
const val DESIGN_SYSTEM_IMPORT = "import br.com.zup.beagle.android.setup.DesignSystem"

const val VALID_DESIGN_SYSTEM =
    """
...
const val VALID_SECOND_DESIGN_SYSTEM =
    """
        @BeagleComponent
...
const val VALID_DESIGN_SYSTEM_BEAGLE_SDK_FROM_REGISTRAR =
    """
        @file:Suppress("OverridingDeprecatedMember", "DEPRECATION", "UNCHECKED_CAST")
