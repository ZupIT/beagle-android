...
const val HTTP_CLIENT_IMPORT = "import br.com.zup.beagle.android.networking.HttpClient"
...
const val VALID_HTTP_CLIENT_BEAGLE_SDK_FROM_REGISTRAR =
    """
        @file:Suppress("OverridingDeprecatedMember", "DEPRECATION", "UNCHECKED_CAST")
        ...
        public final class BeagleSetup : BeagleSdk {
          ...
          public override val httpClient: HttpClient = br.com.test.beagle.HttpClientTestThree()
