...
const val LOGGER_IMPORT = "import br.com.zup.beagle.android.logger.BeagleLogger"

const val VALID_LOGGER =
    """
...
const val VALID_LOGGER_BEAGLE_SDK_FROM_REGISTRAR =
    """
        @file:Suppress("OverridingDeprecatedMember", "DEPRECATION", "UNCHECKED_CAST")
        ...
        public final class BeagleSetup : BeagleSdk {
          ...
          public override val logger: BeagleLogger = br.com.test.beagle.LoggerTestThree()
