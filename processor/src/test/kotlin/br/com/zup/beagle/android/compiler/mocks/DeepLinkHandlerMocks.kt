...
const val DEEP_LINK_HANDLER_IMPORT = "import br.com.zup.beagle.android.navigation.DeepLinkHandler"

const val VALID_DEEP_LINK_HANDLER =
    """
...
const val VALID_SECOND_DEEP_LINK_HANDLER =
    """
        @BeagleComponent
...
const val VALID_DEEP_LINK_HANDLER_BEAGLE_SDK_FROM_REGISTRAR =
    """
        @file:Suppress("OverridingDeprecatedMember", "DEPRECATION", "UNCHECKED_CAST")
        ...
        public final class BeagleSetup : BeagleSdk {
          ...
          public override val deepLinkHandler: DeepLinkHandler =
              br.com.test.beagle.DeepLinkHandlerTestThree()
