...
@file:Suppress("ComplexMethod", "LongMethod",
    "ReturnCount", "MaxLineLength",
    "LoopWithTooManyJumpStatements", "TooGenericExceptionCaught")
 ...
 */
internal class BeagleKotlinJsonAdapter<T>(
...
class BeagleKotlinJsonAdapterFactory : JsonAdapter.Factory {
    override fun create(type: Type, annotations: MutableSet<out Annotation>, moshi: Moshi):
        ...
        val bindingsByName = LinkedHashMap<String, BeagleKotlinJsonAdapter.Binding<Any, Any?>>()
        ...
        for (property in rawTypeKotlin.memberProperties) {
            ...
            bindingsByName[property.name] = BeagleKotlinJsonAdapter.Binding(
                name,
        ...
        val bindings = ArrayList<BeagleKotlinJsonAdapter.Binding<Any, Any?>?>()
        ...
        return BeagleKotlinJsonAdapter(constructor, bindings, nonTransientBindings, options).nullSafe()
    }
}
