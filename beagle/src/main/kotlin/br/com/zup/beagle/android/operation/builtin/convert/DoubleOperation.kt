...
import br.com.zup.beagle.android.operation.convertToDouble

@RegisterOperation("double")
internal class DoubleOperation : Operation {

    override fun execute(vararg params: OperationType?): OperationType {
        if(params.isNullOrEmpty() || params[0] == OperationType.Null) return OperationType.Null

        return params.map { it ?: OperationType.Null }.first().convertToDouble()
    }
}
