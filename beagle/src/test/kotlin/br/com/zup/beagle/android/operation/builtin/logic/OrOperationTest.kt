...
@DisplayName("Given Or Operation")
internal class OrOperationTest {

    val orOperation = OrOperation()
    ...
    inner class Or {
        ...
        fun checkOneParameter() {
            ...
            // WHEN
            val result = orOperation.execute(item)
        ...
        fun checkThreeParameters() {
            ...
            // WHEN
            val result = orOperation.execute(*list)
        ...
        @Test
        @DisplayName("Then should return true")
        fun checkThreeParametersWithTwoFalse() {
            // GIVEN
            val list = arrayOf(
                OperationType.TypeBoolean(false),
                OperationType.TypeBoolean(false),
    ...
    inner class EmptyOperation {
        ...
        fun checkEmptyParameter() {
            // WHEN
            val result = orOperation.execute()
