...
@DisplayName("Given Lower Case Operation")
internal class LowercaseOperationTest {

    val lowercaseOperation = LowercaseOperation()
    ...
    inner class Operation {
        ...
        fun checkStringOne() {
            ...
            // WHEN
            val result = lowercaseOperation.execute(input)
