...
@DisplayName("Given String Operation")
internal class StringOperationTest {
    val operationResolver = StringOperation()
    ...
    inner class StringConversion {
        ...
        fun checkConversion() {
            ...
            assertEquals(expected.map {
                it?.let { OperationType.TypeString(it) } ?: OperationType.Null
            }, result)
        }
    }
