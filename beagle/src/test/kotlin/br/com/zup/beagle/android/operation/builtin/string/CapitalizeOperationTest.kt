...
@DisplayName("Given Capitalize Operation")
internal class CapitalizeOperationTest {

    val capitalizeOperation = CapitalizeOperation()
    ...
    inner class Operation {
        ...
        fun checkStringOne() {
            ...
            // WHEN
            val result = capitalizeOperation.execute(input)
